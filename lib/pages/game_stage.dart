...
class _GameStageState extends State<GameStage> {
  ...
  List<Container> _createPlayerScreens(Map<String, dynamic> data) {
    ...
    _players.forEach((element) {
      _playerScreens.add(_newScreen(element, indexPlayer,data['category'], data['word']));
      indexPlayer++;
    });
    return _playerScreens;
  }

  Container _newScreen(int typePlayer, int numPlayer, String category, String wordIndex) {
    return Container(
      child: Column(
        children: [
          Container(
